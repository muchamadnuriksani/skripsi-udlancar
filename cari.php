<?php 
$q=$jp->sql("select a.*,b.nmkategori from barang a left join kategori b on a.kdkategori=b.kdkategori WHERE (nmkategori LIKE '".'%'."".$_POST[cari]."".'%'."' and stok>0) or (nmbrg LIKE  '".'%'."".$_POST[cari]."".'%'."' and stok>0)");
